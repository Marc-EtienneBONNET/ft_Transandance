...
/*   Updated: 2022/08/08 12:25:18 by mbonnet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
export async function insertGame(app, canvasX){
...
export async function TakeGameByRaq1(app: DataSource){
...
export async function TakeGameByRaq2(app: DataSource){
